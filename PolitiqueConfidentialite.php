    ...
    <main>
        <section id="politiqueConfidentialite">
            ...
            <p>Nous conservons vos données personnelles aussi longtemps que nécessaire pour répondre à vos demandes et pour les analyses nécessaires à l'amélioration de notre site.
                Les données de contact seront conservées pendant 30 jours à partir de la date de la dernière interaction avec vous.
            </p>
            ...
            <ol>
                ...
                <li><strong>Droit de suppression (article 17 RGPD) :</strong> vous pouvez demander à l'effacement ou "droit à l'oubli" (article 17 RGPD) : vous pouvez demander l'effacement de vos données dans certaines conditions.
                </li>
                <li><strong>Droit à la limitation du traitement (article 18 RGPD) :</strong> vous pouvez demander la limitation du traitement de vos données dans certains cas.
                </li>
                <li><strong>Droit à la portabilité (article 20 RGPD) :</strong> vous pouvez recevoir vos données dans un format structuré et les transmettre à un autre organisme.
                </li>
