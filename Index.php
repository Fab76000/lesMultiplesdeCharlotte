...
// Génération du nonce pour les scripts inline
	...
	<main>
		<section class="Hero">
			...
			<div class="presentation-bio stable-bio" style="min-height:320px;">
				...
				<div class="accordion-item">
					<div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionIcon">
		...
		<div class="accordion-item">
			<div class="accordion-header text-center">
				<button class="btn  d-flex justify-content-center align-items-center mx-auto my-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="width:fit-content; background-color: #741d34; color: #fff">
					Contactez-moi !
				</button>
			</div>
					...
					<div class="container mt-4">
						<div class="row">
							<div class="form-9 col-xl-8 col-lg-8 col-md-12 col-sm-12 offset-xl-2">
								...
								<form id="contact-form" method="post" action="php/contact.php" role="form" style="border: 2px solid #000; border-radius: 10px;">
									...
									<div class="controls">
										...
										<div class="form-check mb-2">
											<input type="checkbox" id="data-consent" name="data-consent" class="form-check-input">
											<label for="data-consent" class="form-check-label">
			...
			<div id="cookie-consent-banner" role="dialog" aria-modal="true" tabindex="0" aria-labelledby="cookie-banner-title" aria-describedby="cookie-banner-desc">
				...
				<p id="cookie-banner-desc">
					...
					Ces cookies nous permettent de collecter des données techniques, telles que vos données de navigation, afin d'analyser et d'optimiser notre site. Voici comment nous utilisons vos données :
				</p>
				<p>
					Pour plus d'informations sur la gestion de vos données, consultez notre
					<a href="politiqueConfidentialite.php">politique de confidentialité</a>.
				</p>
