...
<body>
    ...
    <div class="grid-wrap">
        <ul>
            <li><img src="images/2019_L'argent_petite.jpg" alt="photo spectacle l'argent"></li>
            <li><img src="images/Argent_4150_petite.jpg" alt="photo spectacle l'argent"></li>
            <li><img src="images/brancardiere_theatre_de_rue_BXL.jpg" alt="photo spectacle l'argent"></li>
            <li><img src="images/Charlotte_argent.jpg" alt="photo spectacle l'argent"></li>
            <li><img src="images/Charlotte_Narcisse.jpg" alt="photo spectacle l'argent"></li>
